    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center">
      ...
      >
        ...
        <p className="text-white/60 text-base md:text-lg font-light leading-relaxed">
          Whether you're new to faith or growing deeper, we believe God's Word
          has something fresh for you today.
        </p>
  ...
  const BibleStudyTab = () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center">
      ...
      >
        ...
        <p className="text-white/60 text-base md:text-lg font-light leading-relaxed">
          Whether you're just beginning your walk with Jesus or looking to go
          deeper in your faith, this Bible study through the Gospel of Mark is a
          great place to start. Each week, Pastor Deepak Mathew walks through
          the text with thoughtful teaching and practical insight.
        </p>
    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 md:mb-8">
              <div className="relative w-full sm:w-auto">
                <div className="flex items-center gap-4 md:gap-8">
                  <TabButton
                    tab="message"
                    label={isLive ? "Live Now" : "Latest Message"}
          ...
          <div className="relative md:min-h-[375px] flex items-center">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="w-full"
              >
                {activeTab === "message" ? <MessageTab /> : <BibleStudyTab />}
              </motion.div>
            </AnimatePresence>
          </div>
          ...
          >
            {["message", "study"].map((tab) => (
              <button
                key={tab}
                onClick={() => setActiveTab(tab as "message" | "study")}
