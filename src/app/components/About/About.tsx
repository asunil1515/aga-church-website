...
const About = () => {
  ...
  return (
    <section
      id="about"
      aria-label="About Amazing Grace Assembly"
    ...
    >
      ...
      <div className="max-w-6xl mx-auto md:px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <motion.span
              // Spins to 360 when in view
              initial={{ rotate: 0 }}
              whileInView={!shouldReduceMotion ? { rotate: 360 } : undefined}
              transition={
                !shouldReduceMotion
            ...
            <div className="relative bg-white rounded-2xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 overflow-hidden h-full flex flex-col">
              ...
              <div className="mb-4 md:mb-0 z-20">
                <Link
                  ...
                  aria-label="Learn more about Our Beliefs"
                >
                  Our Beliefs
                  <span
          ...
          >
            <div className="relative bg-white rounded-2xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 overflow-hidden h-full flex flex-col">
              ...
              <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-6 flex-grow">
                ...
                community that encourages growth and connection. Whether
                you&apos;re new to the faith or have walked with Jesus for
                years, you&apos;ll find a place to belong.
              </p>
